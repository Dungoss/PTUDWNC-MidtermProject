    ...
    return (
        <div className="footer-container">
            <section className="footer-subscription">
                <p className="footer-subscription-heading">Manage your group in a much easier way</p>
                <p className="footer-subscription-text">Enter your email to receive notifications</p>
